...
tools: Read, Write, Edit, Bash, Grep, Glob, mcp__firecrawl__*
color: yellow
# hooks:
#   PostToolUse:
#     - matcher: "Write|Edit"
...
node "$HOME/.claude/get-stuff-done/bin/gsd-tools.cjs" roadmap update-plan-progress "${PHASE_NUMBER}"
...
```bash
node "$HOME/.claude/get-stuff-done/bin/gsd-tools.cjs" state add-blocker "Blocker description"
```
</state_updates>
