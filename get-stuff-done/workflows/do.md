...
```bash
INIT=$(node "~/.claude/get-stuff-done/bin/gsd-tools.cjs" state load 2>/dev/null)
```
...
| Discussing vision, "how should X look", brainstorming | `/dostuff:discuss-phase` | Needs context gathering |
