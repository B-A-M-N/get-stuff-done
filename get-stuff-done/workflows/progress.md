...
```bash
INIT=$(node "$HOME/.claude/get-stuff-done/bin/gsd-tools.cjs" init progress)
...
- `STATE=$(node "$HOME/.claude/get-stuff-done/bin/gsd-tools.cjs" state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node "$HOME/.claude/get-stuff-done/bin/gsd-tools.cjs" summary-extract <path> --fields one_liner
  ```
