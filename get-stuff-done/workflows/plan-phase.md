...
**If found:**
1. Read template: `~/.claude/get-stuff-done/templates/VALIDATION.md`
...
```bash
node "$HOME/.claude/get-stuff-done/bin/gsd-tools.cjs" verify context-contract "$CONTEXT_PATH" --plan "$PLAN_FILE"
```
