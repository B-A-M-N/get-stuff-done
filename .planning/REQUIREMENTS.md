...
OPEN-BRAIN-03: The system MUST ingest selected Firecrawl-normalized artifacts into Open Brain without coupling Open Brain storage to Second Brain operational tables. | source: Open Brain sidecar definition 2026-03-27
OPEN-BRAIN-04: The system MUST provide bounded semantic retrieval for Open Brain memories ranked by similarity, recency, reuse, and feedback quality rather than exposing raw database rows to prompts. | source: Open Brain sidecar definition 2026-03-27
OPEN-BRAIN-05: The system MUST record recall outcomes so Open Brain ranking can improve over time based on measured helpful and harmful retrieval signals. | source: Open Brain sidecar definition 2026-03-27
